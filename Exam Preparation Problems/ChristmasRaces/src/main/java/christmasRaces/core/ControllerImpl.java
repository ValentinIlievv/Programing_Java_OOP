...
public class ControllerImpl implements Controller {
    ...
    public String startRace(String raceName) {
        ...
        List<Driver> winners = drivers.stream().sorted((firstDriver, secondDriver) ->
                (int) (secondDriver.getCar().calculateRacePoints(laps) - firstDriver.getCar().calculateRacePoints(laps))).limit(3).collect(Collectors.toList());
        ...
        sb.append(String.format(OutputMessages.DRIVER_FIRST_POSITION, firstDriver.getName(), raceName));
        sb.append(System.lineSeparator());
        sb.append(String.format(OutputMessages.DRIVER_SECOND_POSITION, secondDriver.getName(), raceName));
        sb.append(System.lineSeparator());
